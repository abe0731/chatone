...
$(document).ready(function () {
    ...
    function fnc_admin_layout_ctl() {
        ...
        $("#admin_menu_scroll_content").css("height", w_scroll_h + "px");
        $("#admin_user_list_scroll_content").css("height", w_scroll_h_list + "px");
        $("#admin_user_edit_scroll_content").css("height", w_scroll_h_edit + "px");
        $("#admin_grp_edit_scroll_content").css("height", w_scroll_h_list + "px");
        $("#admin_grp_user_edit_scroll_content").css("height", w_scroll_h_list + "px");
        $("#admin_cost_scroll_content").css("height", w_scroll_h + "px");
        $("#admin_data_scroll_content").css("height", w_scroll_h_body + "px");
        $("#admin_summary_scroll_content").css("height", w_scroll_h + "px");
